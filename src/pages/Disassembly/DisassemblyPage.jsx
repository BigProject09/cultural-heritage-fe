...
function DisassemblyPage() {
  ...
  const allCompleted =
    completed.checklist && completed.tool && completed.method;
  ...
  // disassembly_end 인터럽트는 photo_urls/memo resume이 와야만 풀리기 때문에,
  // 아무것도 안 채워도 "다음 단계"를 누르는 시점엔 반드시 한 번은 resume을 보내야 한다.
  // 안 그러면 백엔드 그래프가 이 인터럽트에 멈춘 채로 다음 단계 데이터를 잘못 삼켜버린다.
  const handleSavePost = async () => {
    ...
    try {
      ...
      // 세척이 flow에 없으면 그 다음 활성 단계의 interrupt가 바로 실려온다
  ...
  return (
    <div className="disassembly-page">
      ...
      <div className="page-layout">
        <ProgressNavigator approvedFlow={approvedFlow} currentStep="해체" />
            ...
            <div className="disassembly-container">
              ...
              >
                ...
                <div className="task-content">
                  ...
                  <p>
                    AI가 생성한 체크리스트를 확인하고 작업 전 상태를 점검합니다.
                  </p>
                </div>

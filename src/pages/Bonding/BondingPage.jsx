...
function BondingPage() {
  ...
  // 접합 종료 인터럽트는 photo_urls/memo resume이 와야만 풀리기 때문에,
  ...
  const handleSavePost = async () => {
    ...
    try {
      ...
      // 복원이 flow에 없으면 그 다음 활성 단계의 interrupt가 바로 실려온다
          ...
          <div className="content-columns">
            <div className="bonding-container">
              ...
              >
                <div className="task-icon">
                  {savingSteps.has("bondingMaterial") ? (
            ...
            <div className="post-record-card">
              ...
              <button className="post-record-save-btn" onClick={handleSavePost}>
                {completed.bondingPost ? "✔ 저장됨" : "기록 저장"}
              </button>
            </div>
          </div>
        </div>

...
function SignUpPage() {
  ...
  const getFieldError = (field) =>
    serverFieldErrors[field] || fieldErrors[field] || "";
  ...
  const inputClass = (field) => {
    ...
    return getFieldError(field) ? "invalid" : "valid";
  };
  ...
  const handleSignUp = async (event) => {
    ...
    setError("");
    setServerFieldErrors({ userId: "", email: "" });
    setTouched({
      name: true,
      userId: true,
      email: true,
    ...
    try {
      ...
      if (message.includes("이미 사용 중인 이메일")) {
        ...
        setError("");
      } else if (message.includes("이미 사용 중인 아이디")) {
        setServerFieldErrors((prev) => ({
          ...prev,
          ...
          <section className="heritage-terms-modal">
            ...
            <div className="heritage-terms-content">
              ...
              <p>
                ...
                워크스페이스입니다. 사용자는 서비스 이용 과정에서 관련 법령과
                운영 정책을 준수해야 합니다.
              </p>
              <p>
                서비스에서 제공하는 분석 결과와 보존처리 가이드는 업무를
                보조하기 위한 참고 자료입니다. 실제 보존처리 여부와 방법에 대한
                최종 판단은 사용자와 관련 전문가가 진행해야 합니다.
              </p>
              <h3>개인정보 수집 및 이용 안내</h3>
              <p>
                VORA는 회원가입 및 서비스 제공을 위해 이름, 아이디, 이메일을
                수집하며 비밀번호는 인증을 위해 암호화하여 처리합니다.
              </p>
              <p>
                수집한 개인정보는 회원 관리와 서비스 제공 목적으로만 사용하며,
                회원 탈퇴 또는 보관 기간 종료 시 관련 법령과 내부 정책에 따라
                처리합니다.
              </p>
            </div>
          ...
          <form onSubmit={handleSignUp} noValidate>
            <div className="heritage-signup-grid">
              <label>
                ...
                {touched.name && (
                  <p
                    className={`heritage-field-message ${fieldErrors.name ? "error" : "success"}`}
                  >
                    {fieldErrors.name || "입력되었습니다."}
                  </p>
                )}
              </label>
              ...
              <label className="wide">
                ...
                {touched.userId && (
                  <p
                    className={`heritage-field-message ${getFieldError("userId") ? "error" : "success"}`}
                  >
                    {getFieldError("userId") ||
                      "사용 가능한 형식입니다. 중복 여부는 가입 시 확인합니다."}
                  </p>
                )}
              </label>
              ...
              <label className="wide">
                ...
                {touched.email && (
                  <p
                    className={`heritage-field-message ${getFieldError("email") ? "error" : "success"}`}
                  >
                    {getFieldError("email") || "올바른 이메일 형식입니다."}
                  </p>
                )}
              </label>
              ...
              <label>
                ...
                {touched.password && (
                  <p
                    className={`heritage-field-message ${fieldErrors.password ? "error" : "success"}`}
                  >
                    {fieldErrors.password || "사용 가능한 비밀번호입니다."}
                  </p>
                )}
              </label>
              ...
              <label>
                ...
                {touched.confirmPassword && (
                  <p
                    className={`heritage-field-message ${fieldErrors.confirmPassword ? "error" : "success"}`}
                  >
                    {fieldErrors.confirmPassword || "비밀번호가 일치합니다."}
                  </p>
                )}
              </label>
            </div>

            <p className="heritage-signup-privacy-note">
              개인정보는 계정 운영에 필요한 범위에서만 사용하며, 화면 표시 시
              필요한 정보는 마스킹하여 노출합니다.
            </p>
